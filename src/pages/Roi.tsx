  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <span className="text-xs font-bold text-slate-400 tracking-wider uppercase">Portal &gt; ROI</span>
          <h2 className="text-2xl font-display font-bold text-slate-900 mt-0.5">Return On Investment (ROI)</h2>
          <p className="text-sm text-slate-500 mt-1 font-medium">View active ROI contracts, yields, and payout timelines.</p>
        </div>
      </div>
