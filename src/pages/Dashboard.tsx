          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-2">
              <div className="flex bg-slate-50 p-1 rounded-xl">
                <button className="px-3 py-1.5 text-xs font-bold text-blue-600 bg-white rounded-lg shadow-sm">Chart</button>
                <button className="px-3 py-1.5 text-xs font-bold text-slate-400">List</button>
              </div>
            </div>
          </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-slate-400 font-bold">Role Status</span>
                  <span className="text-xs font-bold bg-blue-500/20 text-blue-400 px-2 py-0.5 rounded-md uppercase">{user?.role}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-slate-400 font-bold">Permissions</span>
