...
export const Investors = () => {
  ...
  const handleOpenEdit = (investor: Investor) => {
    ...
    const resolvedPayoutCycle = investor.payoutType === "Variant"
      ? (investor.roiTypeId === 2 || investor.roiTypeId === "2" ? "Weekly"
        : investor.roiTypeId === 4 || investor.roiTypeId === "4" ? "Quarterly"
        : investor.roiTypeId === 6 || investor.roiTypeId === "6" ? "Half-Yearly"
        : investor.roiTypeId === 5 || investor.roiTypeId === "5" ? "Yearly"
                  ...
                  >
                    ...
                    <table className="w-full text-left border-collapse table-fixed min-w-[900px]">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {currentRows.map((row) => {
                          const isBusiness = row.type === 2 || String(row.type).toLowerCase() === "business";
                          return (
                            <tr 
                              key={row.id} 
                              className="group hover:bg-slate-50/50 transition-colors align-middle"
                            >
                              {/* Name with Investor Type Icon bubble */}
                              <td className="px-6 py-4.5">
                                <div className="flex items-center gap-3">
                                  <div 
                                    ...
                                    title={isBusiness ? "Business Investor" : "Individual Investor"}
                                  >
                                    {isBusiness ? (
